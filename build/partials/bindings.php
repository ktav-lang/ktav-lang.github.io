...
$bindings = [
    ...
    ['name' => 'Java / JVM',      'slug' => 'java',   'ref' => false, 'cmd' => 'implementation("io.github.ktav-lang:ktav:0.6.1")', 'repo' => 'https://github.com/ktav-lang/java', 'note' => 'JDK 17 · JNA', 'noteTitle' => 'Gradle/Maven coordinate io.github.ktav-lang:ktav (on Maven Central); needs JDK 17 and the JNA runtime'],
    ['name' => 'C# / .NET',       'slug' => 'dotnet', 'ref' => false, 'cmd' => 'dotnet add package Ktav',                       'repo' => 'https://github.com/ktav-lang/csharp'],
];

$VSIX = 'https://github.com/ktav-lang/editor/releases/download/v0.6.1/ktav-0.6.1.vsix';
$JB   = 'https://github.com/ktav-lang/editor/releases/download/v0.6.1/ktav-intellij-0.6.1%2B20260605-1423.zip';
?>
